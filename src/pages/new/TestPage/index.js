...
// Path to your model
import model from '~/assets/models/VeSinhQuatSenko.glb';
...
function Scene({ modelTransform, viewMode, onMeshesLoaded, onAnimationsLoaded, activeAnimation }) {
    ...
    return (
        ...
        >
            <DraggablePanelHeader ref={headerRef}>
                ...
                <IconButton size="small" onClick={onMinimizeToggle} sx={{ color: darkMode ? '#fff' : 'inherit' }}>
